<?php
/**
 * Template Name: Inicio (Homepage) - Mejorado
 * Description: CuatriYesoTour Homepage with Gallery, Testimonials, FAQ & Social Proof
 */
?>
<!DOCTYPE html>
<html lang="es">
    ...
    <div class="page">
        ...
        <section class="hero">
            <div class="hero-content">
                ...
                <p>Vive la adrenalina en nuestros tours guiados por expertos. Termas termales y embalse espectacular.</p>
        ...
        <section class="tours-section" id="tours">
            ...
            <div class="tours-grid">
                <!-- Tour Termas -->
                <div class="tour-card">
                    <div class="tour-image" style="background-image: url('https://cuatriyesotour.com/wp-content/uploads/2026/07/IMG_2488-scaled.jpg');"></div>
                    <div class="tour-info">
                        <h3>Tour Termas Valle de Colina</h3>
                        <div class="tour-time">⏰ 09:30 – 14:30</div>
                        <p>Recorre los espectaculares Baños Morales y termas naturales en el corazón de la cordillera. Una experiencia única rodeado de montañas y naturaleza pura.</p>
                ...
                <div class="tour-card">
                    ...
                    <div class="tour-info">
                        <h3>Tour Embalse El Yeso</h3>
                        <div class="tour-time">⏰ 15:00 – 17:30</div>
                        <p>Disfruta de vistas panorámicas del majestuoso Embalse El Yeso. Un recorrido de adrenalina con paisajes que te dejarán sin aliento.</p>
                        <ul class="tour-details">
                        ...
                        <div class="tour-price">$85.000 CLP</div>
                        <a href="/reservas" class="btn-book">Reservar</a>
                    </div>
                </div>
            </div>
        ...
        <section class="gallery-section" id="gallery">
            ...
            <div class="gallery-grid">
                <div class="gallery-item">
                    <img src="https://cuatriyesotour.com/wp-content/uploads/2026/07/IMG_2488-scaled.jpg" alt="Termas Valle de Colina">
                </div>
                <div class="gallery-item">
                    <img src="https://cuatriyesotour.com/wp-content/uploads/2026/05/embalse-2.jpg" alt="Embalse El Yeso">
                </div>
                <div class="gallery-item">
                    <img src="https://cuatriyesotour.com/wp-content/uploads/2026/07/IMG_2488-scaled.jpg" alt="Cuatrimotos">
                </div>
                <div class="gallery-item">
                    <img src="https://cuatriyesotour.com/wp-content/uploads/2026/05/embalse-2.jpg" alt="Paisajes">
                </div>
                <div class="gallery-item">
                    <img src="https://cuatriyesotour.com/wp-content/uploads/2026/07/IMG_2488-scaled.jpg" alt="Experiencia">
                </div>
                <div class="gallery-item">
                    <img src="https://cuatriyesotour.com/wp-content/uploads/2026/05/embalse-2.jpg" alt="Diversión">
                </div>
            </div>
        </section>
        ...
        <section class="testimonials-section" id="testimonials">
            ...
            <div class="testimonials-grid">
                ...
                <div class="testimonial-card">
                    <div class="star-rating">★★★★★</div>
                    <p class="testimonial-text">"Tour perfecto para familias. Las termas fueron relajantes después de la aventura en cuatrimoto. Muy recomendado para pasar un día diferente."</p>
        ...
        <section class="faq-section">
            ...
            <div class="faq-container">
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Te recomendamos llevar: protector solar, repelente de insectos, ropa cómoda y cerrada, zapatos deportivos seguros, una muda de ropa si planeas entrar a las termas, toalla, y una bolsa impermeable para tus objetos de valor. Nosotros proporcionamos todo el equipo de seguridad.</p>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question" onclick="toggleFaq(this)">
                        <h4>¿Incluye almuerzo o refrigerio?</h4>
                        <span class="faq-toggle">+</span>
                    </div>
                    <div class="faq-answer">
                        <p>El tour incluye acceso a las termas naturales y agua fresca durante el recorrido. Te recomendamos llevar snacks o almuerzo si lo deseas. Algunos tours tienen paradas estratégicas donde puedes descansar y refrescarte.</p>
                    </div>
                </div>
        ...
        <footer>
            ...
            <p>Aventuras en cuatrimoto en el Cajón del Maipo | Termas y Embalse</p>
